            ...
            <div className='w-full max-w-[1460px] mx-auto px-4 py-10'>
                ...
                <ul className='space-y-6'>
                    {[{ src: bolim1, alt: "bolim1", title: "Профессиональное обслуживание клиентов", link: '/Bolim1' },
                      { src: bolim4, alt: "bolim4", title: "Советы покупателям", link: '/Bolim4' },
                      { src: bolim5, alt: "bolim5", title: "JAMI Style & Branding", link: '/Bolim5' }
                    ].map((item, index) => (
                        <li key={index} className='flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6 py-4 px-5 border rounded-md'>
                            <div className='flex-1'>
                                ...
                                <div className='flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 mt-4'>
                                    <img className='w-[100px] sm:w-64 md:w-80 lg:w-96 h-auto' src={item.src} alt={item.alt} />
...
export default MaqolalarVaMaslahatlar4;

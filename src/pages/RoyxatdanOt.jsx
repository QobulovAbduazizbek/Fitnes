        ...
        <div className='bg-white'>
            ...
            <div className='flex flex-col items-center'>
                <div className='flex items-center mb-7'>
                    <Link to={'/'} className="text-red-600 text-[16px]"> <u>Главная</u><span className='mx-1'>/</span></Link>
                    <Link to={'/SingUp'} className="text-red-600 text-[16px]"> <u>Регистрация</u><span className='mx-1'>/</span></Link>
                ...
                <div className=' flex flex-col md:flex-row items-center md:items-start'>
                    <div className='mr-0 md:mr-36 mb-10 md:mb-0'>
                        ...
                        <div>
                            <Link to={'/RoyhatdanOt'} className='bg-[#19579e] w-full md:w-auto px-3 py-2 rounded-lg border-2 border-[#19579e] text-white font-bold '>Зарегистрироваться</Link>
                        </div>
                    </div>

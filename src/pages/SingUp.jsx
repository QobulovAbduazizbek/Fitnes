...
const SignUp = () => {
    return (
        <div className='bg-white'>
          ...
          <Link to={'/'} className="text-red-600 text-[16px]">
            <u>Главная</u>
          </Link>
          <span className='mx-1'>/</span>
          <Link to={'/SingUp'} className="text-red-600 text-[16px]">
                    ...
                    <div className='border-2 py-4 md:py-5 px-3 md:px-5'>
                        ...
                        <div className='flex flex-col md:flex-row items-start md:justify-between'>
                            <div className="mb-4 md:mb-0 md:mr-4">
                                ...
                                <div>
                                    <div className="flex flex-col md:flex-row md:items-center">
                                        ...
                                        <Link className='text-[16px] md:text-[18px] text-red-600 md:ml-2 mb-2'>Забыли пароль?</Link>
                                    </div>
                                    ...
                                    <div className='flex items-center'>
                                        ...
                                        <Link to={'/RoyhatdanOt'} className='bg-white w-full md:w-[180px] text-center py-2 rounded-lg border-2 border-[#19579e] text-[#19579e] font-bold hover:bg-[#19579e] hover:text-white duration-500'>Зарегистрироваться</Link>
                                    </div>
                                </div>
                            </div>
                            <div className='text-start'>
                                ...
                                <a href='https://mos-977225.oml.ru/user/agreement' target='_blank' className='text-red-600 text-[14px] md:text-[16px] hover:underline' to={'/FoydalanishSharti'}> <u>принимаете пользовательское соглашение</u> </a>
                            </div>
                        </div>
                    </div>
                </div>
